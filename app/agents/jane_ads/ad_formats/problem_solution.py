...
def _problem_prompt(problem_situation: str, nigerian_setting: str, seasonal_context: Optional[str] = None) -> str:
    ...
    return (
        ...
        "desaturated natural colours with overcast or shaded daylight. "
...
def _solution_prompt(
    ...
    return (
        ...
        "outcome. Use brighter natural daylight and warmer but realistic tones. "
        "Do not make the result look exaggerated, luxurious or impossibly "
        "perfect. Match the problem image's camera angle and framing so the "
        "two feel like deliberate visual counterparts. Preserve a clear "
