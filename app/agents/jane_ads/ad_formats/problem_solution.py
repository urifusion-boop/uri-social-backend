...
def _problem_prompt(problem_situation: str, nigerian_setting: str, seasonal_context: Optional[str] = None) -> str:
    ...
    return (
        ...
        "upper body clearly visible — never just legs or backs. Show one "
        "clear human situation that communicates the problem instantly, with "
        "the relevant object or context visible. Concentrate the subject and "
        ...
        "daylight. The image should feel observed rather than staged: "
...
def _solution_prompt(
    ...
    return (
        ...
        "organised and satisfying. Concentrate the subject and action in the "
        ...
        "realistic tones. Not exaggerated or impossibly perfect. The contrast "
        f"should come from the situation itself, not colour grading.{(' ' + seasonal) if seasonal else ''}"
    )
